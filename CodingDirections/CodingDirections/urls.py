...
urlpatterns = [
    ...
    path(r'create-travel-package/', views.create_travel_package, name='create-travel-package'),
    path(r'edit-travel-package/', views.edit_travel_package, name='edit-travel-package'),
