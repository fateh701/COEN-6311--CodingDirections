...
@Component({
  selector: 'app-custom-bookings-review',
  templateUrl: './custom-bookings-review.component.html',
  styleUrl: './custom-bookings-review.component.css'
})
export class CustomBookingsReviewComponent {
  selectedBooking: any = {};
  allbookingsbyID: any[] = [];
  ...
  bookNow=(packageItem: any)=>{
    ...
    this.router.navigate(['/custom-bookings-confirmation', packageItem.id]);
  }
